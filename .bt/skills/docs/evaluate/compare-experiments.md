...
> Identify which test cases improved or regressed between runs. Set a baseline experiment to align test cases and compare score deltas side by side.
...
* **Download as CSV or JSON** — for further analysis, importing into another tool, or sharing raw data. Click <Icon icon="download" /> **Download** in the toolbar and choose a format. Capped at 1,000 rows in the UI. Use the [API](/api-reference) for larger exports.

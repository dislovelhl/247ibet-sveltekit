...
> Find traces based on meaning rather than keywords. Deep search uses AI to surface relevant results even when traces don't contain your exact search terms.

...
> Build custom dashboards to track request counts, latency, costs, scores, and other metrics across your logs and experiments over time.
...
<div style={{maxWidth: '300px'}}>
  <img src="https://mintcdn.com/braintrust/Bjcuf6lz_PKwdl1A/images/monitor-timeframe.png?fit=max&auto=format&n=Bjcuf6lz_PKwdl1A&q=85&s=cad24d5d557043ac2bdef4aba5ba1355" alt="Monitor page" width="476" height="818" data-path="images/monitor-timeframe.png" />
</div>

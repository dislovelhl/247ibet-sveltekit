...
Read the install guide from the local docs: `/home/martin/Downloads/247ibet-sveltekit/.bt/skills/docs/sdk-install/typescript.md`
...
If the SDK does not print a URL, construct one manually using the URL format documented in `/home/martin/Downloads/247ibet-sveltekit/.bt/skills/docs/sdk-install/braintrust-url-formats.md`:

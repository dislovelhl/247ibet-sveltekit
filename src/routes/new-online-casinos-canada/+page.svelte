  ...
  const faqItems = [
    {
      ...
      answer:
        'New casinos operating in Ontario must be licensed and registered with the AGCO before accepting bets. This means they are subject to the same player protection requirements, AML rules, and technical standards as established operators. Always verify AGCO licence status at iagco.ca before depositing.',
    },
    {
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Review the best new online casinos for Canadians in 2026. We evaluate recently launched operators for licensing, game selection, Interac support, and RG tools."
  />
    ...
    schema={{
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://247ibet.ca' },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'New Online Casinos',
          item: 'https://247ibet.ca/new-online-casinos-canada',
        },
      ],
    }}
  />

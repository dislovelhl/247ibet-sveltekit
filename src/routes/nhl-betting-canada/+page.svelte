<script lang="ts">
  ...
  const bettingTypes = [
    {
      type: 'Moneyline',
      ex: 'Maple Leafs -130 vs Senators +110',
      desc: 'Bet on who wins the game outright. No spread — just pick the winner. Favourite pays less than +100; underdog pays more.',
    },
    {
      type: 'Puck Line',
      ex: 'Oilers -1.5 goals (-150)',
      desc: 'Similar to a point spread for hockey. The favourite needs a 2+ goal margin to cover. The underdog loses by 1 goal or wins — and still covers. Typical puck line is -1.5 or +1.5.',
    },
    {
      type: 'Total (Over/Under)',
      ex: 'Over 5.5 goals (-110)',
      desc: 'Bet on whether the total goals in the game goes over or under a set line. 5.5 is the most common total in NHL betting.',
    },
    {
      type: 'Period Betting',
      ex: '1st Period Result — Leafs -110',
      desc: 'Bet on the outcome of an individual period. Popular for in-play betting after the game starts.',
    },
    {
      type: 'Player Props',
      ex: 'McDavid Over 0.5 points (-165)',
      desc: 'Bet on individual player statistics — points, goals, assists, shots on goal. Available at major sportsbooks.',
    },
    {
      type: 'Live In-Play',
      ex: 'Canucks to win from 0-1 down (+250)',
...
<svelte:head>
  ...
  <meta
    property="og:title"
    content="NHL Betting Canada 2026 — Best Sites, Odds &amp; Tips | 247iBET"
  />
  <meta
    ...
    schema={{
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://247ibet.ca' },
        {
          ...
          position: 2,
          name: 'NHL Betting',
          item: 'https://247ibet.ca/nhl-betting-canada',
        },
      ],
    }}
  />

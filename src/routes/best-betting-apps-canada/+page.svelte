    ...
    schema={{
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://247ibet.ca' },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Best Betting Apps',
          item: 'https://247ibet.ca/best-betting-apps-canada',
        },
      ],
    }}
  />
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20 max-w-5xl">
  <header class="mb-10">
    ...
    <p class="max-w-3xl text-base leading-relaxed text-[#94A3B8]">
      Field-tested mobile rankings for iOS and Android sportsbooks in Canada. Evaluated on biometric
      login security, SGP builder latency, and AGCO-compliant responsible gambling tools for
      on-the-go wagering.
    </p>
  ...
  <div class="mt-10 space-y-10 sm:mt-12 sm:space-y-12">
    <div class="navy-card rounded-xl p-5 sm:p-6 md:p-8">
      ...
      <p class="mt-3 text-xs font-sans text-gray-600">
        For live in-play betting, native apps consistently outperform mobile web on latency and

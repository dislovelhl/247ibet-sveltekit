...
<svelte:head>
  ...
  <meta name="description" content="Expert casino and sportsbook operator review for Canadian players." />
  <link rel="canonical" href="https://247ibet.ca/reviews/{$page.params.slug}" />
</svelte:head>
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 max-w-5xl">
  ...
  <p class="max-w-3xl text-base leading-relaxed text-[#94A3B8] mb-8">
    Detailed operator review for Canadian players — covering payout speed, Interac support, game library, and compliance status.
  </p>

  <div class="navy-card rounded-2xl p-8 text-center">
    <p class="text-text-tertiary text-sm">Full review content is loaded dynamically. Wire up <code class="text-prestige-gold">+page.ts</code> to fetch operator data.</p>
  </div>

  <div class="mt-12">
    <IBetShowcase variant="banner" ctaText="Play at 247iBET" contextLabel="Fast CAD payouts · Interac deposits · 19+" />
  </div>

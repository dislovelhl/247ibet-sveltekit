...
>
  ...
  <div class="grid gap-6 md:grid-cols-3 not-prose mb-16">
    <article class="glass-thin group rounded-3xl p-8 transition-all hover:bg-navy-raised hover:shadow-2xl border border-white/5">

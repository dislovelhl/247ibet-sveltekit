...
<svelte:head>
  ...
  <meta
    name="description"
    content="247iBET earns revenue from public-site CTA routing and owned brand surfaces. Read how we disclose commercial relationships and manage conflicts of interest."
  />
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 pb-20 max-w-4xl">
  ...
  <header class="navy-card rounded-3xl p-6 md:p-10 mb-10 relative overflow-hidden">
    ...
    <div class="relative z-10">
      ...
      <p class="text-lg text-gray-300 font-sans max-w-2xl leading-relaxed">
        247iBET.ca is the public web home for 247iBET brand, guides, tools, and support content.
        High-intent CTAs are handoffs to the separate gaming platform, where readers must verify
        eligibility, current terms, account requirements, and jurisdictional availability.
      </p>
    </div>
  </header>
  ...
  <section class="navy-card rounded-2xl p-6 mb-6">
    ...
    <div class="space-y-3 text-sm text-gray-400 font-sans leading-relaxed">
      <p>
        247iBET.ca is the public digital home for <strong class="text-white"
          >247iBET brand, guidance, and platform handoff content</strong
        >. This website serves these public-web purposes:
      </p>
      <ul class="space-y-1.5 pl-4">
        {#each ['Guides, tools, and regulatory information to help Canadian players choose how to play', 'Platform handoff: operator CTAs route users to the separate gaming platform, where availability, eligibility, and account terms must be verified', 'Compliance resource: AGCO regulatory information, responsible gambling tools, and provincial legal guidance'] as item}
      ...
      <p>
        ...
        Revenue may be generated when readers complete qualifying actions after a disclosed platform or
        operator handoff.
      </p>
    </div>
  </section>
      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-white/5">
          <tr>
            ...
            <td class="p-4 text-gray-300">247iBET public-site CTAs and owned routing surfaces</td>
  ...
  <section class="navy-card rounded-2xl p-6 mb-6">
    ...
    <div class="space-y-3 text-sm text-gray-400 font-sans leading-relaxed">
      <p>
        247iBET public-web content is written with awareness of the Alcohol and Gaming Commission of
        Ontario's
      ...
      <p>
        ...
        and directs readers to the operating platform or official sources to verify current terms.
      </p>
      <p>
        If you believe any public 247iBET content is misleading or inconsistent with Canadian
  ...
  <section class="navy-card rounded-2xl p-6 mb-6">
    ...
    <p class="text-sm text-gray-400 font-sans">
      Operator logos, names, and any "Visit Site" / operator-handoff buttons are affiliate links

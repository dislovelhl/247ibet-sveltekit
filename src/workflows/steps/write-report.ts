...
const DEFAULT_REPORT_ROOT = '.workflow-data/reports';
...
export async function writeReport(
  ...
  'use step';
  const reportRoot = process.env.WORKFLOW_REPORT_DIR?.trim() || DEFAULT_REPORT_ROOT;
  const reportDir = resolve(reportRoot, dir);
